...
//        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (o.equals(btnThem)) {
            ...
            String maLoai = loaiPhongDAO.getMaFromLoai(cboFilterLoaiPhong.getSelectedItem().toString(), cboFilterChatLuong.getSelectedItem().toString());
            ...
            if (cboFilterTinhTrang.getSelectedIndex() == 0) {
                ...
                rowSorter.setRowFilter(RowFilter.regexFilter(cboFilterTinhTrang.getSelectedItem().toString(), 3));
            }
